...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('c31_c31', (
            ...
            ('icd', self.gf('django.db.models.fields.CharField')(default='', max_length=1)),
        ...
        db.send_create_signal('c31', ['c31'])


    def backwards(self, orm):
        # Deleting model 'c31'
        db.delete_table('c31_c31')
    ...
    models = {
        ...
        'c31.c31': {
            ...
            'icd': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
