...
class c21(models.Model):
    ...
    first_dose                      = models.IntegerField(_('First dose'), max_length=10, null=True, blank=True)
    ...
    second_dose                     = models.IntegerField(_('Second dose'), max_length=10, null=True, blank=True)
    name_of_other_dose              = models.CharField(_("Name of other dose"), max_length=255, null=True, blank=True)
    other_dose                      = models.IntegerField(_('Other dose'), max_length=10, null=True, blank=True)
    ...
    date_of_first_dose              = models.DateTimeField(_('Date of first dose'))
    total_dose_in_24h               = models.FloatField(_('Total doses in 24 hours'), max_length=10)
    date_of_last_dose               = models.DateTimeField(_('Date of last dose'))
