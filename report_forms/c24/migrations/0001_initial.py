...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('c24', ['Medicine'])

        # Adding model 'c24'
        db.create_table('c24_c24', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('name_of_first_dose', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='First Dose', null=True, to=orm['c24.Medicine'])),
            ('first_dose', self.gf('django.db.models.fields.FloatField')(max_length=10, null=True, blank=True)),
            ('name_of_second_dose', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Second Dose', null=True, to=orm['c24.Medicine'])),
        ...
        db.send_create_signal('c24', ['c24'])


    def backwards(self, orm):
        # Deleting model 'Medicine'
        db.delete_table('c24_medicine')

        # Deleting model 'c24'
        db.delete_table('c24_c24')
    ...
    models = {
        ...
        'c24.c24': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name_of_first_dose': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'First Dose'", 'null': 'True', 'to': "orm['c24.Medicine']"}),
            'name_of_other_dose': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name_of_second_dose': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Second Dose'", 'null': 'True', 'to': "orm['c24.Medicine']"}),
