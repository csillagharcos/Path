...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('r1_r1', (
            ...
            ('field_of_rehab', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('field_of_rehab_other', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('date_of_admission', self.gf('django.db.models.fields.DateField')()),
            ('FIM_applied', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('FIM_date_of_assess', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('FIM_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('BI_applied', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('BI_date_of_assess', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('BI_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('SMWT_applied', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('SMWT_date_of_assess', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('SMWT_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('SF_applied', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('SF_date_of_assess', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('SF_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('SAT_applied', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('SAT_date_of_assess', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('SAT_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('FEV_applied', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('FEV_date_of_assess', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('FEV_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('AI_applied', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('AI_date_of_assess', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('AI_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('SNC_applied', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('SNC_date_of_assess', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('SNC_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('SCI_applied', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('SCI_date_of_assess', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('SCI_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('Other_applied', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('Other_name_of', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('Other_date_of_assess', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('Other_score', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('patient_discharge_status', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('discharge', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('date_of_discharge', self.gf('django.db.models.fields.DateField')()),
            ('FIM_applied_discharge', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('FIM_date_of_assess_discharge', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('FIM_score_discharge', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('BI_applied_discharge', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('BI_date_of_assess_discharge', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('BI_score_discharge', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('SMWT_applied_discharge', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('SMWT_date_of_assess_discharge', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('SMWT_score_discharge', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('SF_applied_discharge', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('SF_date_of_assess_discharge', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('SF_score_discharge', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('SAT_applied_discharge', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('SAT_date_of_assess_discharge', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('SAT_score_discharge', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('FEV_applied_discharge', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('FEV_date_of_assess_discharge', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('FEV_score_discharge', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('AI_applied_discharge', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('AI_date_of_assess_discharge', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('AI_score_discharge', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('SNC_applied_discharge', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('SNC_date_of_assess_discharge', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('SNC_score_discharge', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('SCI_applied_discharge', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('SCI_date_of_assess_discharge', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('SCI_score_discharge', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('Other_applied_discharge', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1)),
            ('Other_name_of_discharge', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('Other_date_of_assess_discharge', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('Other_score_discharge', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ...
        db.send_create_signal('r1', ['r1'])


    def backwards(self, orm):
        # Deleting model 'r1'
        db.delete_table('r1_r1')
