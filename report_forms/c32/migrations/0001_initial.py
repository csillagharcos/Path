...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('c32_c32', (
            ...
            ('icd', self.gf('django.db.models.fields.CharField')(default='', max_length=3)),
        ...
        db.send_create_signal('c32', ['c32'])


    def backwards(self, orm):
        # Deleting model 'c32'
        db.delete_table('c32_c32')
    ...
    models = {
        ...
        'c32.c32': {
            ...
            'icd': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '3'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
