...
class C8Form(ModelForm):
    ...
    date_of_surgical_procedure  = forms.DateTimeField(label=_('Date of hospital discharge'), widget=forms.TextInput(attrs={'class':'datepicker', 'placeholder':_('[click here]')}))
    class Meta:
        model = c8
        exclude = ('added_by')
