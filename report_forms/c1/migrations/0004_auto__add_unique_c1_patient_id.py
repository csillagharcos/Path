...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'c1', fields ['patient_id']
        db.create_unique('c1_c1', ['patient_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'c1', fields ['patient_id']
        db.delete_unique('c1_c1', ['patient_id'])
