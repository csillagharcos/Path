...
from report_forms.c23.models import c23, ROUTE_OF_ADMIN_CHOICES, PENICILIN_ALLERGY_CHOICES
...
class C23Form(ModelForm):
    ...
    date_of_first_dose      = forms.DateTimeField(label=_('Date of first dose'), required=False, widget=forms.TextInput(attrs={'class':'datetimepicker', 'placeholder':_('[click here]')}))
    ...
    date_of_last_dose       = forms.DateTimeField(label=_('Date of last dose'), required=False, widget=forms.TextInput(attrs={'class':'datetimepicker', 'placeholder':_('[click here]')}))
